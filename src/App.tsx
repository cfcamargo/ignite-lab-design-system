    ...
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      ...
      <footer className='flex flex-col gap-4 items-center mt-8'>
        <Text asChild size='sm' >
          <a href="" className='text-gray-400 underline text-xs'>Esqueceu sua senha ?</a>
        </Text>
        <Text asChild size='sm'>
          <a href="" className='text-gray-400 underline text-xs'>Não possui conta? Crie uma agora</a>
        </Text>
      </footer>
    </div>
  )
